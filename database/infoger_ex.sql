...
-- Listage des données de la table infoger.nom_parametre : ~3 rows (environ)
...
-- Listage des données de la table infoger.parametre : ~4 rows (environ)
...
-- Listage des données de la table infoger.service : ~4 rows (environ)
DELETE FROM `service`;
...
-- Listage des données de la table infoger.status : ~5 rows (environ)
DELETE FROM `status`;
