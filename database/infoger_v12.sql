...
INSERT INTO `client` (`Id_client`, `tel_referent`, `mail_referent`, `nom_entreprise`, `adresse_entreprise`, `nom_referent`) VALUES
	(1, 'tel_referent1', 'mail_referent1', 'nom_entreprise111', 'adresse_ent', 'nom_referent1'),
...
DROP TABLE IF EXISTS `nom_parametre`;
...
DROP TABLE IF EXISTS `nom_status`;
...
DROP TRIGGER IF EXISTS `historise_client`;
