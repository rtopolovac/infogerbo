...
INSERT INTO `client` (`Id_client`, `tel_referent`, `mail_referent`, `nom_entreprise`, `adresse_entreprise`, `nom_referent`) VALUES
	(1, 'tel_referent1', 'mail_referent1', 'nom_entreprise11234', 'adresse_ent', 'nom_referent1hrthtr'),
	...
	(20, '', 're', '', '', 're'),
	(21, '', '', '', '', ''),
	(22, 'je suis dazdazdd', 'ru ets ', 'je suis adazd', 'je suis zdzad', 'zefaz'),
	(23, 'htrhtrhtr', 'htrhtrehrt', 'hrthtrhtr', 'htrhtrhtr', 'h(trhtrhgt');
...
-- Listage des données de la table infoger.log_client : ~17 rows (environ)
